...
export function ContextMenuPlugin(): JSX.Element {
  ...
  const items = useMemo(() => {
    return [
      new NodeContextMenuOption(`Supprimer le lien`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Couper`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Copier`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Coller`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Coller en tant que texte brut`, {
        $onSelect: () => {
          navigator.clipboard.read().then(async function (...args) {
            const permission = await navigator.permissions.query({
              // @ts-expect-error These types are incorrect.
      ...
      new NodeContextMenuSeparator(),
      new NodeContextMenuOption(`Supprimer le nœud`, {
        $onSelect: () => {
