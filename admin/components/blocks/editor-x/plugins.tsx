...
const placeholder = "Commencez à taper ici...";
const maxLength = 500;
...
export function Plugins({}) {
  ...
  return (
    <div className="relative h-full">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex items-center gap-2 overflow-auto border-b p-2 py-3">
      ...
      <div className="relative h-full">
        ...
        />
        {/* TypingPerfPlugin disabled - performance overlay not needed */}
        {/* <TypingPerfPlugin /> */}
        <TabFocusPlugin />
        <AutocompletePlugin />
        <AutoLinkPlugin />
