...
import { DraggableEvent } from "@/app/components/calendar/dnd/draggable-event";
import { ResizableEvent } from "@/app/components/calendar/dnd/resizable-event";
import {
  formatTime,
...
export function EventBlock({ event, className }: IProps) {
  ...
  const appointmentVariant = getAppointmentVariant(event.status, event.paid);
  const color = (
    badgeVariant === "dot" ? `${appointmentVariant}-dot` : appointmentVariant
